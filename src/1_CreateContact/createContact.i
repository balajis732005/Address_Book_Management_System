# 0 "src/1_CreateContact/createContact.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/1_CreateContact/createContact.c"
# 1 "src/1_CreateContact/createContact.h" 1
...
# 5 "src/1_CreateContact/createContact.h" 2
...
# 6 "src/1_CreateContact/createContact.h" 2
...
# 7 "src/1_CreateContact/createContact.h" 2
# 1 "src/1_CreateContact/../contact.h" 1
# 12 "src/1_CreateContact/../contact.h"
...
# 8 "src/1_CreateContact/createContact.h" 2
...
# 2 "src/1_CreateContact/createContact.c" 2
...
void getUserName(char *userName){
    ...
    scanf("%30[^\n]", userName);
    __fpurge(
# 66 "src/1_CreateContact/createContact.c" 3 4
            stdin
# 66 "src/1_CreateContact/createContact.c"
                 );
}
...
void getUserPhoneNumber(char *userPhoneNumber){
    ...
    scanf("%10[^\n]", userPhoneNumber);
    __fpurge(
# 76 "src/1_CreateContact/createContact.c" 3 4
            stdin
# 76 "src/1_CreateContact/createContact.c"
                 );
}
...
void getUserEmailId(char *userEmailId){
    ...
    scanf("%50[^\n]", userEmailId);
    __fpurge(
# 109 "src/1_CreateContact/createContact.c" 3 4
            stdin
# 109 "src/1_CreateContact/createContact.c"
                 );
}
...
int validateUserEmailId(char *userEmailId, AddressBook *addressBook){
    ...
    while(token){
        tokenCount++;
        token = strtok(
# 133 "src/1_CreateContact/createContact.c" 3 4
                      ((void *)0)
# 133 "src/1_CreateContact/createContact.c"
                          , delimeters);
    }
