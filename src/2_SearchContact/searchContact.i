# 0 "src/2_SearchContact/searchContact.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/2_SearchContact/searchContact.c"
# 1 "src/2_SearchContact/searchContact.h" 1
...
# 5 "src/2_SearchContact/searchContact.h" 2
...
# 6 "src/2_SearchContact/searchContact.h" 2
...
# 7 "src/2_SearchContact/searchContact.h" 2
# 1 "src/2_SearchContact/../contact.h" 1
# 12 "src/2_SearchContact/../contact.h"
...
# 8 "src/2_SearchContact/searchContact.h" 2
...
# 2 "src/2_SearchContact/searchContact.c" 2
...
int searchContact(AddressBook *addressBook, int searchOption, char *multipleMatchFoundName){
    ...
    switch(searchOption){
        case 1:
            ...
            printf("------------------------\n");
            char nameToSearch[31];
            printf("\nEnter the user name to search: ");
            scanf("%30[^\n]", nameToSearch);
            __fpurge(
# 16 "src/2_SearchContact/searchContact.c" 3 4
                    stdin
# 16 "src/2_SearchContact/searchContact.c"
                         );
        ...
        case 2:
            ...
            printf("--------------------------------\n");
            char phoneNumberToSearch[11];
            printf("\nEnter the phone number to search: ");
            scanf("%10[^\n]", phoneNumberToSearch);
            __fpurge(
# 31 "src/2_SearchContact/searchContact.c" 3 4
                    stdin
# 31 "src/2_SearchContact/searchContact.c"
                         );
        ...
        case 3:
            ...
            printf("----------------------------\n");
            char emailIdToSerach[51];
            printf("\nEnter the email id to search: ");
            scanf("%50[^\n]", emailIdToSerach);
            __fpurge(
# 43 "src/2_SearchContact/searchContact.c" 3 4
                    stdin
# 43 "src/2_SearchContact/searchContact.c"
                         );
