# 0 "src/3_EditContact/editContact.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/3_EditContact/editContact.c"
# 1 "src/3_EditContact/editContact.h" 1
...
# 5 "src/3_EditContact/editContact.h" 2
...
# 6 "src/3_EditContact/editContact.h" 2
...
# 7 "src/3_EditContact/editContact.h" 2
# 1 "src/3_EditContact/../contact.h" 1
# 12 "src/3_EditContact/../contact.h"
...
# 8 "src/3_EditContact/editContact.h" 2
...
# 2 "src/3_EditContact/editContact.c" 2
...
void getUpdatedUserName(char *updatedName){
    ...
    scanf("%30[^\n]", updatedName);
    __fpurge(
# 82 "src/3_EditContact/editContact.c" 3 4
            stdin
# 82 "src/3_EditContact/editContact.c"
                 );
}
...
void getUpdatedUserPhoneNumber(char *updatedPhoneNumber){
    ...
    scanf("%10[^\n]", updatedPhoneNumber);
    __fpurge(
# 88 "src/3_EditContact/editContact.c" 3 4
            stdin
# 88 "src/3_EditContact/editContact.c"
                 );
}
...
void getUpdatedUserEmailId(char *updatedEmailId){
    ...
    scanf("%50[^\n]", updatedEmailId);
    __fpurge(
# 94 "src/3_EditContact/editContact.c" 3 4
            stdin
# 94 "src/3_EditContact/editContact.c"
                 );
}
