...
void exportContacts();
void performImportContact(AddressBook *);
void importContacts(char *, AddressBook *);
# 2 "src/main.c" 2
...
int main(){
    ...
    int userChoice;
    int searchResult;
    char multipleMatchFoundName[31];
